...
// Dont use other words or numbers and only one of each bracket
//  Post-condition: this will tell you if your string is valid or not
public static void isValid(String test){
  //this tests if it has all the brackets required and then if any of them are in the wrong spot
